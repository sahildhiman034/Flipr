			...
			721: () => {
				! function() {
					...
					e.addEventListener("click", (() => {
						t.classList.contains("active") ? (t.classList.remove("active"), e.classList.remove("active-burger"), s.classList.remove("locked")) : (t.classList.add("active"), e.classList.add("active-burger"), s.classList.add("locked"))
					})), window.addEventListener("resize", (() => {
						window.innerWidth > 991.98 && (t.classList.remove("active"), e.classList.remove("active-burger"), s.classList.remove("locked"))
					}))
			...
			598: () => {
				function e(e) {
					...
					document.addEventListener("keydown", (function(s) {
						...
						var s, i, l;
						r(e.target) && (t || (i = (s = e.target).type, "INPUT" === (l = s.tagName) && n[i] && !s.readOnly || "TEXTAREA" === l && !s.readOnly || s.isContentEditable)) && a(e.target)
	...
	function s(i) {
		...
		function k(e) {
			...
			if (l.noSwiping && (v ? function(e, t = this) {
				...
				}(m, p[0]) : p.closest(m)[0])) return void(t.allowClick = !0);
			...
			if (Object.assign(r, {
					...
					isScrolling: void 0,
					startMoving: void 0
				}), o.startX = w, o.startY = b, r.touchStartTime = g(), t.allowClick = !0, t.updateSize(), t.swipeDirection = void 0, l.threshold > 0 && (r.allowThresholdMove = !1), "touchstart" !== c.type) {
				let e = !0;
		...
		function O(e) {
			...
			if (c > i.longSwipesMs) {
				...
				"next" === t.swipeDirection && (w >= i.longSwipesRatio ? t.slideTo(i.rewind && t.isEnd ? f : u + b) : t.slideTo(u)), "prev" === t.swipeDirection && (w > 1 - i.longSwipesRatio ? t.slideTo(u + b) : null !== v && w < 0 && Math.abs(w) > i.longSwipesRatio ? t.slideTo(v) : t.slideTo(u))
			} else {
				if (!i.shortSwipes) return void t.slideTo(t.activeIndex);
				!t.navigation || o.target !== t.navigation.nextEl && o.target !== t.navigation.prevEl ? ("next" === t.swipeDirection && t.slideTo(null !== f ? f : u + b), "prev" === t.swipeDirection && t.slideTo(null !== v ? v : u)) : o.target === t.navigation.nextEl ? t.slideTo(u + b) : t.slideTo(u)
			}
		}
		...
		const N = (e, t) => {
				...
				(i.preventClicks || i.preventClicksPropagation) && a[p]("click", e.onClick, !0), i.cssMode && l[p]("scroll", e.onScroll), i.updateOnWindowResize ? e[u](o.ios || o.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", A, !0) : e[u]("observerUpdate", A, !0)
			},
			_ = {
				attachEvents: function() {
					...
					e.onTouchStart = k.bind(e), e.onTouchMove = P.bind(e), e.onTouchEnd = O.bind(e), s.cssMode && (e.onScroll = I.bind(e)), e.onClick = z.bind(e), i.touch && !D && (t.addEventListener("touchstart", G), D = !0), N(e, "on")
				},
		...
		class W {
			constructor(...e) {
				let t, s;
				if (1 === e.length && e[0].constructor && "Object" === Object.prototype.toString.call(e[0]).slice(8, -1) ? s = e[0] : [t, s] = e, s || (s = {}), s = w({}, s), t && !s.el && (s.el = t), s.el && f(s.el).length > 1) {
					const e = [];
				...
				const r = w({}, F, n);
				return i.params = w({}, r, q, s), i.originalParams = w({}, i.params), i.passedParams = w({}, s), i.params && i.params.on && Object.keys(i.params.on).forEach((e => {
		...
		R.use([function({
			...
			function d() {
				...
				if ("fraction" === s.type && (d.find(X(s.currentClass)).text(s.formatFractionCurrent(c + 1)), d.find(X(s.totalClass)).text(s.formatFractionTotal(p))), "progressbar" === s.type) {
					let t;
					t = s.progressbarOpposite ? e.isHorizontal() ? "vertical" : "horizontal" : e.isHorizontal() ? "horizontal" : "vertical";
					const i = (c + 1) / p;
					let n = 1,
						r = 1;
					"horizontal" === t ? n = i : r = i, d.find(X(s.progressbarFillClass)).transform(`translate3d(0,0,0) scaleX(${n}) scaleY(${r})`).transition(e.params.speed)
				}
			...
			function u() {
				...
				s.removeClass(t.hiddenClass), s.removeClass(t.modifierClass + t.type), s.removeClass(e.isHorizontal() ? t.horizontalClass : t.verticalClass), e.pagination.bullets && e.pagination.bullets.removeClass && e.pagination.bullets.removeClass(t.bulletActiveClass), t.clickable && s.off("click", X(t.bulletClass))
			}
			s("init", (() => {
